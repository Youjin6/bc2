...
public class TwoDimArray {
    ...
    public static int getInput(Scanner keyboard) {
        int number;                   // holds the input number
        final int MAX_NUMBER = 10;    // holds the limit size
    ...
    public static void showTwoDimArray(int number) {
        ...
        // Populates and displays the 2D array and
        ...
        // Prints out the sum of left diagonal
        ...
        // Prints out the sum of the right diagonal
        System.out.printf("  %5d\n", rightDiagonal);
    }


    /**
     * Runs the program as many times as the users want.
     *
     * @param keyboard A Scanner
     */
